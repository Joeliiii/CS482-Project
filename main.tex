...
Yohann: This project seemed very daunting at first but, with routine and practice, I learned how to work as a team with my partners in order to make good progress. If I had to do something differently I would be more punctual with my iterations and analyze my code better to make sure it was the best possible version. I would also try harder to implement the feedback I received from previous iterations into future iterations. 
\section*{Appendix}
